...
public class NPCInteract : MonoBehaviour
{
    ...
    private void Start(){
        ...
        interactText.text = "Use the Left Joystick to navigate. Use the Right Trigger to interact. Navigate into the room (Left Joystick), interact with a character (Right Trigger), and introduce yourself to them. Take a slow, deep breath and know it's okay to feel nervous. Focus on maintaining eye contact and speaking clearly. Now, go say “Hi” and introduce yourself to someone…You’ve got this!";
    ...
    public IEnumerator NPCInitiates(){
        ...
        interactText.text = "Interact audibly (Hold A Button & speak) with the character who approaches you and asks for your opinion. Respond honestly to their questions. State your opinion respectfully. It’s ok to disagree. Take a minute to appreciate yourself. Your thoughts and opinions are valid and matter.";
    ...
    IEnumerator MeetingDialog(){
        ...
        interactText.text = "Approach the podium to introduce yourself. Interact with the podium (Right Trigger) to start and stop your speech timer. Say hello, tell everyone your name, what your current job title is, and what you do in your job. Try to talk for 90 seconds or more. End your speech by thanking the audience for their attention and telling them you are happy to be there. Take your time. Take slow, deep breaths in (count to 4) and out (count to 6). Focus on the message you want to convey rather than other people.";
